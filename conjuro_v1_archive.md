...
- Control de versiones via Git es consistente con la filosofía del proyecto
...
- [ ] Deploy inicial a Vercel (vacío pero funcional)
...
- [ ] Layout base funcional (header/footer/theme/i18n) y deploy preview activo.
...
- [ ] **Texts híbridos** — Formato donde se visualiza la contribución humana y agéntica (sidebyside, annotations, o metadata)
